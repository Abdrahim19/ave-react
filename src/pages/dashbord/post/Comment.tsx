...
<div className="size-30px align-items-start">
</div>
<div className="p-4 rounded-5" style={{backgroundColor:"#f6f8fa"}}>
...
<div className="flex-items flex-wrap justify-content-between gap-1 px-4 py-3">
